...
" INTO OUTFILE '/var/www/piping/webservice/gsd/",
REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(db.database_name, ' ', '_'), '-', '_'),'\.', '_'), '&_', ''), '\(', ''), '\)', ''),
...
INTO OUTFILE '/var/www/piping/backend/export_gsds_to_webservice.sql' FIELDS TERMINATED BY ' ' ESCAPED BY '' LINES TERMINATED BY '\n';