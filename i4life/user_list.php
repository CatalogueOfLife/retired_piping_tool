...
// $Id: user_list.php,v 1.1 2011/06/02 11:10:10 kwok Exp $
...
elseif (isset($_POST['editUser']) && $_POST['users'])
{
...
elseif (isset($_POST['deleteUser']) && $_POST['users'])
{
	// initialise User object
	$user = new User($db);
...
$smarty->assign('page_title', 'Piping Tools User Table');
